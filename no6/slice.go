...
In case there only exists one int, the resulting slice begins in the position indicated by
the int and ends at the end of the received slice.
...
func Slice(a []string, nbrs ...int) []string {
	...
	if start < 0 || start >= n || start >= end || end < 0 || end > n {
